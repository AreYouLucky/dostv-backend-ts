...
function AdvertisementForm() {
    ...
    return (
        <>
            ...
            <LoadingDialog show={createAdvertisement.isPending || updateAdvertisement.isPending} message={'Uploading Advertisement Details ...'} />
        </>
    )

}
AdvertisementForm.layout = (page: React.ReactNode) => <AppLayout breadcrumbs={breadcrumbs}>{page}</AppLayout>;
