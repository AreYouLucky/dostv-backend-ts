                        ...
                        <PaginatedSearchTable<BannerModel>
                            ...
                            renderRow={(r) => (
                                <tr key={r.banner_id} className="border-b  duration-300 hover:scale-101 cursor-pointer">
                                    ...
                                    <td className="px-6 py-1.5 text-[11px] text-justify">{r.description !== '' ? trimText(r.description as string, 255) : 'Not Set'}</td>
                                    <td className="px-6 py-1.5 text-start text-[11px]">{bannerTypes.find(b => b.code === r.type)?.label}</td>
                                    <td >
