    ...
    return (
        <>
            ...
            <div className="flex min-h-svh flex-col items-center justify-center gap-6 p-6 md:pt-7 poppins-regular">
                <div className="w-full max-w-sm rounded-lg bg-linear-to-t from-gray-900/80 from-20% to-teal-600/80 xx px-10 pt-15 pb-10 border border-gray-700 shadow-2xl shadow-gray-400">
