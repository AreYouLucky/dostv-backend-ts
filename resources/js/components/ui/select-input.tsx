    ...
    return (
        <div className={`relative ${className}`}>
            <select
                ...
                onChange={onChange}
                className={cn(
                    "border-gray-300 file:text-foreground text-gray-800 placeholder:text-gray-500 selection:bg-primary selection:text-gray-800 flex h-12 w-full min-w-0 rounded-lg border bg-transparent px-3 py-2 pr-10", // ✅ ADD pr-10 here
