        ...
        <Dialog open={props.show} onOpenChange={props.onClose}>
            <DialogContent className="text-gray-600 p-10 ">
                <DialogHeader>
                    <DialogTitle >
                        <div className='text-9xl flex justify-center'>
                            {props.type == 1 ? <FaInfoCircle className='text-blue-400'/> : <IoWarning className='text-teal-500' />}
                        </div></DialogTitle>
                ...
                <div className="w-full flex justify-center gap-2">
                    {props.type == 2 && <Button className="text-gray-50 bg-teal-700 text-sm" onClick={props.onConfirm}>Accept</Button>}
